...
public class ItemTouchAdapter extends CommonAdapter<Bean> {
    ...
    public void convert(int position, final CommonHolder holder, Bean item) {
        if (mIsLinear) {
            holder.setVisibility(R.id.llyt_style0, View.VISIBLE);
            holder.setVisibility(R.id.v_style0, View.VISIBLE);
            holder.setVisibility(R.id.tv_style1, View.GONE);
            linearConvert(holder, item);
        } else {
            holder.setVisibility(R.id.llyt_style0, View.GONE);
            holder.setVisibility(R.id.v_style0, View.GONE);
            holder.setVisibility(R.id.tv_style1, View.VISIBLE);
    ...
    private void gridConvert(final CommonHolder holder, Bean item) {
        ...
        tvHandler.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN && getItemCount() > 1 && mStartDragListener != null) {
